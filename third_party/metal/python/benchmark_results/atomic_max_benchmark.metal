...
// Benchmark kernel for atomic max operation
kernel void benchmark_atomic_max(
    ...
    for (uint i = 0; i < iterations; i++) {
        ...
        atomic_fetch_max_explicit((_Atomic int*)&result_int[0], as_type<int>(val), memory_order_relaxed);
    }
